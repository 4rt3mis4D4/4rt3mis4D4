...
Sou estudante de Ciência da Computação e utilizo este perfil para compartilhar projetos acadêmicos, exercícios práticos e experimentos que refletem minha evolução como desenvolvedora, mantendo foco em aprendizado contínuo, na aplicação de boas práticas de programação e na exploração de novas tecnologias.
